                                ...
                                <form action="codigo.php" method="POST">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            <label> Nombre de municipalidad </label>
                                        ...
                                        <div class="form-group">
                                            <label> Ubicacion de municipalidad</label>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" name="btn_admin2"
                                            class="btn btn-primary">Guardar Municipalidad</button>
                                    </div>
                                </form>
                            </div>
                        </div>
...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">Editar Municipalidad </h6>
  </div>
...
<?php
 $conexion = mysqli_connect("localhost","root","","transmetro_bd")or die ("No se ha podido conectar al servidor de Base de datos");
     ...
     if (isset($_POST['edit_btn2'])) {
         ...
         $query = "SELECT * FROM municipalidad WHERE Id_muni ='$id' ";
         ...
         foreach ($query_run as $row) {
            ...
            <form action="codigo.php" method="POST">
                     ...
                     <div class="form-group">
                        <label> No. Municipalidad </label>
                        <input type="text" name="Id_muni" value="<?php echo $row['Id_muni'] ?>" class="form-control">
                    </div>
                    <div class="form-group">
                        <label> Nombre Municipalidad</label>
                    ...
                    <div class="form-group">
                        <label>No. Estacion</label>
                        <input type="text" name="Estacion_fk" value="<?php echo $row['Estacion_fk'] ?>"  class="form-control">
                    </div>   
                    
                        <a href="muni.php" class="btn btn-danger">Cancelar</a>
                        <button type="submit" name="updatebtnAdmin2" class="btn btn-success"> Actualizar </button>
            </form>
        <?php
        }
    }
