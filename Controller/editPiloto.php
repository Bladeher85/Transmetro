                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="Historial_edu" class="form-control"
                                                placeholder="Ingrese nivel educativo">
                                        </div> 
                                        <div class="form-group">
...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">Editar Piloto </h6>
  </div>
...
<?php
 $conexion = mysqli_connect("localhost","root","","transmetro_bd")or die ("No se ha podido conectar al servidor de Base de datos");
     ...
     if (isset($_POST['edit_btn1'])) {
         ...
         $query = "SELECT * FROM piloto WHERE id_piloto ='$id' ";
         ...
         foreach ($query_run as $row) {
            ...
            <form action="codigo.php" method="POST">
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" name="Id_piloto" value="<?php echo $row['Id_piloto'] ?>" class="form-control">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label> Nivel Educativo</label>
                        <input type="text" name="Historial_edu" value="<?php echo $row['Historial_edu'] ?>" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>Direccion</label>
                    ...
                    <div class="form-group">
                        ...
                        <a href="piloto1.php" class="btn btn-danger">Cancelar</a>
                        <button type="submit" name="updatebtnAdmin1" class="btn btn-success"> Actualizar </button>
            </form>
        <?php
        }
    }
