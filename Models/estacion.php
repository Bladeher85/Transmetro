                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            ...
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                <h1 class="h3 mb-0 text-gray-800">ESTACIONES DE TRANSMETROS</h1>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                $sql = "SELECT Id_estacion, Nombre, Ubicacion, Linea_fk
                                        FROM Estacion
                                ...
                                echo "<td class=p-1 align=center> No. Estacion</td>";
                                echo "<td align=center> Nombre de Estacion </td>";
                                ...
                                echo "</table>";
                                $total_registros = mysqli_num_rows(mysqli_query($conexion, "SELECT Id_estacion FROM Estacion"));
                                $total_paginas = ceil($total_registros / $registros_por_pagina);
                                
                                echo "<div class='text-center'>";
                                if ($pagina_actual > 1) {
                                    echo "<a href='estacion.php?pagina=" . ($pagina_actual - 1) . "' class='btn btn-primary'>Regresar</a>";
                                }
                                
                                if ($pagina_actual < $total_paginas) {
                                    echo "<a href='estacion.php?pagina=" . ($pagina_actual + 1) . "' class='btn btn-primary'>Siguiente página</a>";
                                }
                                echo "</div>";
                                ?>
                                <!-- fin TABLA -->
