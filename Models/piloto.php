        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            ...
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                <h1 class="h3 mb-0 text-gray-800">PILOTOS DE TRANSMETROS</h1>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                $sql = "SELECT Id_piloto, Nombre, Historial_edu, Direccion, Telefono
                                FROM Piloto
                                ...
                                echo "<td class=p-1 align=center> No. Piloto</td>";
                                echo "<td align=center> Nombre de piloto </td>";
                                echo "<td class=p-1 align=center>Historial educativo</td>";
                                echo "<td class=p-1 align=center>Direccion</td>";
                                ...
                                $total_registros = mysqli_num_rows(mysqli_query($conexion, "SELECT Id_piloto FROM Piloto"));
                                $total_paginas = ceil($total_registros / $registros_por_pagina);
                                
                                echo "<div class='text-center'>";
                                if ($pagina_actual > 1) {
                                    echo "<a href='piloto.php?pagina=" . ($pagina_actual - 1) . "' class='btn btn-primary'>Regresar</a>";
                                }
                                
                                if ($pagina_actual < $total_paginas) {
                                    echo "<a href='piloto.php?pagina=" . ($pagina_actual + 1) . "' class='btn btn-primary'>Siguiente página</a>";
                                }
                                echo "</div>";
                                ?>
                                <!-- fin TABLA -->
                    ...
                    <img class="mx-auto d-block" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQuZs81LOjB_9cK1F4lBuheL7Gj6Q3klwQwSGO2Xj6tpA&s">
