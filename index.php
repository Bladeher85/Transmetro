        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item"><a href="Models/estacion.php" class="nav-link">Estaciones</a></li>
                    <li class="nav-item"><a href="Models/piloto.php" class="nav-link">Pilotos</a></li>
                    <li class="nav-item"><a href="Models/rutas.php" class="nav-link">Rutas</a></li>
                    <li class="nav-item"><a href="Models/mapa.php" class="nav-link">Mapa</a></li>
    ...
    <img src="Views/images/logo.png" class="logo">
      ...
      <div class="hero">
        <video autoplay loop muted plays-inline class="back-video">
            <source src="Views/images/video.mp4" type="video/mp4">
        </video>
